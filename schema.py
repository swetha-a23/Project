...
class Query:
    ...
    def getAllSuppliers(self) -> List[SupplierSchema]:
        SupplierDao = Stock.getAllSuppliers
        SupplierSchema = {}
    ...
    def getSupplierById(self, supplier_id: int) -> SupplierSchema:
        SupplierDao = Stock.getSupplierById(supplier_id)
        SupplierSchema = {}
        SupplierSchema["supplier_id"]=SupplierDao.supplier_id
        SupplierSchema["supplier_name"]=SupplierDao.supplier_name
        SupplierSchema["supplier_address"]=SupplierDao.supplier_address
    ...
    def getStockById(self, stock_id: int) -> StockSchema:
        StockDao = Stock.getStockById(stock_id)
        StockSchema = {}
        StockSchema["stock_id"]=StockDao.stock_id
        StockSchema["product_id"]=StockDao.product_id
        StockSchema["quantity"]=StockDao.quantity
    ...
    def getAllConsumers(self) -> List[ConsumerSchema]:
        ConsumerDao = Consumer.getAllConsumers
        ConsumerSchema = {}
    ...
    def getConsumerById(self, consumer_id: int) -> ConsumerSchema:
        Consumer = Consumer.getConsumerById(consumer_id)
        ConsumerSchema = {}
        ConsumerSchema["consumer_id"]=Consumer.consumer_id
        ConsumerSchema["consumer_name"]=Consumer.consumer_name
        ConsumerSchema["consumer_address"]=Consumer.consumer_address
        ConsumerSchema["consumer_number"]=Consumer.consumer_number
        
        

    
    def getAllProducts(self) -> List[ProductSchema]:
        ProductDao = Product.getAllProducts
        ProductSchema = {}
    ...
    def getProductById(self, product_id: int) -> ProductSchema:
        ProductDao = Product.getProductById(product_id)
        ProductSchema = {}
        ProductSchema["product_id"]=ProductDao.product_id
    ...
    def getAllSupplierOrders(self) -> List[SupplierOrderSchema]:
        SupplierOrderDao = SupplierOrder.getAllSupplierOrders
        SupplierOrderSchema = {}
    ...
    def getSupplierOrderById(self, order_id: int) -> SupplierOrderSchema:
        SupplierOrderDao = SupplierOrder.getSupplierOrderById(order_id)
        SupplierOrderSchema = {}
        SupplierOrderSchema["order_id"]=SupplierOrderDao.order_id
        SupplierOrderSchema["supplier_id"]=SupplierOrderDao.supplier_id
        SupplierOrderSchema["stock_id"] = SupplierOrderDao.stock_id
    ...
    def getAllConsumerOrders(self) -> List[ConsumerOrderSchema]:
        ConsumerOrderDao = ConsumerOrder.getAllConsumerOrders
        ConsumerOrderSchema = {}
    ...
    def getConsumerOrderById(self, order_id: int) -> ConsumerOrderSchema:
        ConsumerOrderDao = ConsumerOrder.getConsumerOrderById(order_id)
        ConsumerOrderSchema = {}
        ConsumerOrderSchema["order_id"]=ConsumerOrderDao.order_id
    ...
    def getAllSupplierTransactions(self) -> List[SupplierTransactionSchema]:
        SupplierTransactionsDao = SupplierTransaction.getAllSupplierTransactions
    ...
    def getSupplierTransactionById(self, transaction_id : int) -> SupplierTransactionSchema:
        SupplierTransactionsDao = SupplierTransaction.getSupplierTransactionById(transaction_id)
        SupplierTransactionsSchema = {}
    ...
    def getAllConsumerTransactions(self) -> List[ConsumerTransactionSchema]:
        ConsumerTransactionsDao = ConsumerTransaction.getAllConsumerTransactions
    ...
    def getConsumerTransactionById(self, transaction_id: int) -> ConsumerTransactionSchema:
        ConsumerTransactionsDao = ConsumerTransaction.getConsumerTransactionById(transaction_id)
        ConsumerTransactionsSchema = {}
